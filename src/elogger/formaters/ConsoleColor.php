 ...
 */
class ConsoleColor extends Standart
{
     ...
     */
    public $colors = array(
        ELogger::TRACE   => self::COLORFG_LGRAY,
        ELogger::LOG     => self::COLORFG_WHITE,
        ELogger::SUCCESS => array(self::COLORFG_BLACK, self::COLORBG_GREEN),
        ELogger::ERROR   => array(self::COLORFG_BLACK, self::COLORBG_RED),
        ELogger::FATAL   => array(self::COLORFG_YELLOW, self::COLORBG_RED),
    );
